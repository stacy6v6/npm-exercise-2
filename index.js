...
while(iterator < combinedArg.length) {
    ...
    if (combinedArg[iterator].toLowerCase() === `a` || combinedArg[iterator].toLowerCase() === `e` || combinedArg[iterator].toLowerCase() === `i` || combinedArg[iterator].toLowerCase() === `o` || combinedArg[iterator].toLowerCase() === `u`) {
        vowelCount++;
    } 
    iterator++;
}
